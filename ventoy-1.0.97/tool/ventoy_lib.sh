...
#                    | Defined names of ansi terminal codes to change
#                    | color of text and put them in rentoy_lib.sh
#_____________________________________________________________________
#
VENT_VER="ventoy-1.0.97"
source ${0%UUI4Linux*}/UUI4Linux/${VENT_VER}/tool/rentoy_lib.sh
...
echo -e "${ansi_GREEN}$*${ansi_RESTORE}"
}

vtwarn() {
#    echo -e "\033[33m$*\033[0m"
    echo -e "${ansi_YELLOW}$*${ansi_RESTORE}"
}


vterr() {
#    echo -e "\033[31m$*\033[0m"
    echo -e "${ansi_RED}$*${ansi_RESTORE}"
}
